function processed = listen_to_fittest(noisy,clean, params)
    ...
    processed = noise_gate(percent_wiener * WienerNoiseReduction(noisy, fs, alpha_wiener) + (1 - percent_wiener) * spectral_subtraction(noisy, fs, alpha_specsub), threshold, attack, release);
